...
class RhythmWidgetWorker(
    ...
    override suspend fun doWork(): Result {
        return try {
            ...
            val songTitle = prefs.getString(RhythmMusicWidget.KEY_SONG_TITLE, "No song playing") ?: "No song playing"
            val artistName = prefs.getString(RhythmMusicWidget.KEY_ARTIST_NAME, "Unknown artist") ?: "Unknown artist"
